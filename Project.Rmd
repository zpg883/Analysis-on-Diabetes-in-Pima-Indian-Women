...
Support Vector Machine is a supervised learning and constructs hyper plane surfaces that predicts whether the examples fall into one class or other separated by a margin and classifies examples with a largest margin.
...
### Random Forest
Random Forest is an extension of the decision tree and it produces different categories based on the predictors. This method is good for our analysis so that way we can categorize each health-related predictor.
...
**Observation:**
It was observed that the best mtry value was 8, which gave an Accuracy of 0.7446912 and a Kappa value of 0.4238059 on the training data. When the test data was used we saw an Accuracy of 0.7865 and a Kappa value of 0.5108.
...
**Conclusion:**
In conclusion, the method that performs the best model was the Logistic Regression. As a result of Logistic Regression performing the best, it is a binary approach which works well with the Pima Indian dataset as it was a binary dataset. Our conclusion is based on the Kappa and Accucracy levels. 
