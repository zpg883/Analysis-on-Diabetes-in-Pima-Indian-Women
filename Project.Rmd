...
The objective of this analysis is to predict if a patient has diabetes by applying various statistical machine learning methods. The patient data can be found from the Pima Indians Diabetes Data.
...
It was observed that the best k value was 5, which gave an Accuracy of 0.7380823 and a Kappa value of 0.4115603 on the training data. When the test data was used we saw an Accuracy of 0.7656 and a Kappa value of 0.4429.
...
**Observation:**
It was observed that the best C value was .125, which gave an Accuracy of 0.7535664 and a Kappa value of 0.4587120 on the training data. When the test data was used we saw an Accuracy of 0.7865 and a Kappa value of 0.4879.
...
**Observation:**
It was observed that the best mtry value was 8, which gave an Accuracy of 0.7481549 and a Kappa value of 0.4460567 on the training data. When the test data was used we saw an Accuracy of 0.75 and a Kappa value of 0.3391.
...
**Observation:**
It was observed that the best decay value was 0.0001, which gave an Accuracy of 0.7587719 and a Kappa value of 0.4492371 on the training data. When the test data was used we saw an Accuracy of 0.7812 and a Kappa value of 0.4998.
...
**Conclusion:**
Looking over all the metrics to evaluate performance it was observed that Logistic Regression had the best performance for the Kappa statistic of 0.4997519 and the ROC curve with an area of 0.8758. The SVM model seemed to perform better when using the accuracy statistic with a value of 0.7864583 compared to the accuracy from the Logistic Regression model of 0.7812500. Overall we would recommend the Logistic Regression model, as the Kappa and ROC curve were observed to be the best performing. Additionally, the Outcome variable capturing Diabetes status is binary, which works well with a Logistic Regression model. 
