...
SVMTune <- train(x = diabetesTrain_minusInsulinSkin[-7],
...
```{r, echo=FALSE}
set.seed(100)
confusionMatrix(data = predict(SVMTune, diabetesTest_minusInsulinSkin[-7]), reference = diabetesTest_minusInsulinSkin$Outcome)
```
...
logisticTune  =  train(x = diabetesTrain[-9], y = diabetesTrain$Outcome, method = "multinom", metric = "Accuracy", trControl = ctrl)
logisticTune
